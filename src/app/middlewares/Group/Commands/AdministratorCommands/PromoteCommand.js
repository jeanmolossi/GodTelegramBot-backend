...
class PromoteCommand extends Composer {
  constructor() {
    ...
    this.command('/helper', this.promoteAction.bind(this));
    this.command('/submoderador', this.promoteAction.bind(this));
    this.command('/moderador', this.promoteAction.bind(this));
    this.command('/freeuser', this.promoteAction.bind(this));
